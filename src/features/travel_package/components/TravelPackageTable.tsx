...
type Props = {
  data: ITravelPackageReturn | undefined;
  perPage: number;
  isFetching: boolean;
  rowsPerPage?: number[];
...
export function TravelPackagesTable({
  ...
  function mapDataToGridRows(data: ITravelPackageReturn) {
    const { data: travelPackages } = data;
    return travelPackages.map((travelPackages) => ({
      id: travelPackages._id,
